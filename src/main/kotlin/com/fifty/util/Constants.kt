...
object Constants {
    ...
    const val BASE_URL = "http://192.168.64.113:8080/"
    ...
    const val DEFAULT_PROFILE_PICTURE_PATH = "profile_pictures/avatar.svg"
    const val DEFAULT_BANNER_IMAGE_PATH = "profile_pictures/default_banner.jpg"
}